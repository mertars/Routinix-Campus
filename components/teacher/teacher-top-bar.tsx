  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        {/* Mobil düzen — ölçüldü: eskiden 6 ayrı yuvarlak buton
            (değiştirici + arama + çıplak logo + görünüm + kurum rozeti +
            çıkış) tek satıra sıkışıyor, kurum adı "Kont…" diye kırpılıyordu.
            Çıplak logo kaldırıldı (ModuleSwitcher zaten kimliği taşıyor);
            görünüm/kurum/çıkış TEK "Ayarlar" popup'ına toplandı (bkz.
            teacher-appearance-popup.tsx) — satırda artık 3 öğe var. */}
