      ...
      {view === "edit" ? (
        <div className="grid gap-4 lg:grid-cols-[180px_1fr]">
          <motion.div
            ...
            className="rounded-3xl border border-hairline bg-white/70 p-4 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-midnight-card/70"
          >
          ...
          <motion.div
            whileHover={{ scale: 1.005, y: -2 }}
            className="overflow-x-auto rounded-3xl border border-hairline bg-white/70 p-4 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-midnight-card/70"
          >
