    ...
    <div className="space-y-4">
      <motion.div
        ...
        className={cn(
          ...
          lesson.isLive ? "bg-green-600 text-white shadow-sm" : "border border-hairline bg-white/70 text-espresso-muted backdrop-blur-sm dark:border-white/10 dark:bg-midnight-card/50 dark:hover:border-brand-500/30 dark:text-cream/40"
        )}
      >
        {lesson.isLive ? (
