...
export function PomodoroTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div whileHover={{ scale: 1.005, y: -2 }} className="rounded-3xl border border-hairline bg-white/70 p-6 text-center shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-midnight-card/70">
