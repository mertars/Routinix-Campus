export type RoleId = "principal" | "teacher" | "student";
...
export const RISK_REASON_LABEL: Record<RiskReason, string> = {
  net_drop: "Net Düşüşü",
  study_gap: "Çalışma Saati Çakılması",
};
...
export const INITIAL_SCHEDULE: ScheduleAssignment[] = [
  { id: "s1", branchId: "12a", day: "Pazartesi", slot: "16:00-17:00", teacherName: "İrfan Hoca", subject: "Matematik" },
  { id: "s2", branchId: "12a", day: "Çarşamba", slot: "17:00-18:00", teacherName: "Kemal Hoca", subject: "Fizik" },
  { id: "s3", branchId: "10a", day: "Salı", slot: "16:00-17:00", teacherName: "Selin Hoca", subject: "Türkçe" },
  { id: "s4", branchId: "11a", day: "Perşembe", slot: "18:00-19:00", teacherName: "Kemal Hoca", subject: "Fizik" },
  { id: "s5", branchId: "lgs", day: "Cuma", slot: "16:00-17:00", teacherName: "Ayşe Hoca", subject: "LGS Branş" },
  { id: "s6", branchId: "11a", day: "Salı", slot: "17:00-18:00", teacherName: "İrfan Hoca", subject: "Matematik" },
  { id: "s7", branchId: "mezun", day: "Çarşamba", slot: "18:00-19:00", teacherName: "İrfan Hoca", subject: "Matematik" },
  { id: "s8", branchId: "12a", day: "Perşembe", slot: "16:00-17:00", teacherName: "İrfan Hoca", subject: "Matematik" },
  { id: "s9", branchId: "11a", day: "Cuma", slot: "17:00-18:00", teacherName: "İrfan Hoca", subject: "Matematik" },
];
...
// ----------------------------------------------------------------------------
// Mezun Takip & Gurur Tablosu (Alumnus Network)
// ----------------------------------------------------------------------------
...
export const ALUMNI: Alumnus[] = [
  {
    ...
    name: "Deniz Aksoy",
    graduationYear: 2025,
    highSchoolRank: "Kurum 1.si",
    admittedTo: "Boğaziçi Üniversitesi — Bilgisayar Mühendisliği",
    examScope: "YKS",
    isMentor: true,
    mentorNote: "Sayısal netleri artırma ve YKS kaygısı üzerine mentorluk veriyor.",
  },
  {
    id: "al2",
    name: "Elif Karahan",
    graduationYear: 2025,
    highSchoolRank: "Kurum 2.si",
    admittedTo: "Hacettepe Üniversitesi — Tıp Fakültesi",
    examScope: "YKS",
    isMentor: true,
    mentorNote: "Çalışma programı disiplini ve motivasyon konularında destek veriyor.",
  },
  {
    id: "al3",
    name: "Berk Yalman",
    graduationYear: 2024,
    admittedTo: "ODTÜ — Elektrik-Elektronik Mühendisliği",
    examScope: "YKS",
    isMentor: false,
  },
  {
    ...
    name: "Naz Özdemir",
    graduationYear: 2024,
    highSchoolRank: "Kurum 3.si",
    admittedTo: "İTÜ — Endüstri Mühendisliği",
    examScope: "YKS",
    isMentor: true,
    mentorNote: "Sözel/sayısal denge stratejisi ve zaman yönetimi konusunda mentorluk veriyor.",
  },
  {
    id: "al5",
    name: "Kaan Ersoy",
    graduationYear: 2023,
    admittedTo: "Marmara Üniversitesi — Hukuk Fakültesi",
    examScope: "YKS",
    isMentor: false,
  },
  {
    ...
    graduationYear: 2023,
    highSchoolRank: "Kurum 1.si",
    admittedTo: "Galatasaray Lisesi",
    examScope: "LGS",
    isMentor: true,
    mentorNote: "LGS sınav kaygısı ve soru çözüm hızı üzerine mentorluk veriyor.",
  },
  {
    id: "al7",
    name: "Ege Bulut",
    graduationYear: 2022,
    admittedTo: "Yıldız Teknik Üniversitesi — Mimarlık",
    examScope: "YKS",
    isMentor: false,
  },
  {
    ...
    name: "Sude Kaplan",
    graduationYear: 2022,
    highSchoolRank: "Kurum 4.si",
    admittedTo: "Ege Üniversitesi — Diş Hekimliği",
    examScope: "YKS",
    isMentor: true,
    mentorNote: "Sağlık bilimleri tercih stratejisi konusunda mentorluk veriyor.",
  },
];
