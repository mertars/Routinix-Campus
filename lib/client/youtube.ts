...
// altyapısından geliyor. youtube-nocookie.com domaini kullanılıyor
// (YouTube'un çerezsiz/az izlenimli embed varyantı) — video "bizim
// sistemde" hissi verir, öğrenci hiç youtube.com'a yönlendirilmez.
