...
- **Gerçek dosya yükleme**: `lib/server/uploads/save-question-image.ts`, `save-teacher-material.ts` — yerel diske (`public/uploads/...`) yazar, gerçek bir URL döner. Yeni bir görsel yükleme akışı gerekiyorsa BUNLARI yeniden kullan, yeni bir yükleme yardımcısı YAZMA.
